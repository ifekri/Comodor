...
Moved to `references/design-systems.md` — Brief → design system map. Read it with `read_skill_file` when this step needs it.
...
Moved to `references/playbooks.md` — Context-aware proactivity, per brief type. Read it with `read_skill_file` when this step needs it.
...
Moved to `references/vocabulary.md` — Dial definitions. Read it with `read_skill_file` when this step needs it.
...
Moved to `references/ai-tells.md` — The forbidden patterns, in full. Read it with `read_skill_file` when this step needs it.

## 10. REFERENCE VOCABULARY (Pattern Names the Agent Should Know)

Moved to `references/vocabulary.md` — Reference vocabulary. Read it with `read_skill_file` when this step needs it.

## 11. REDESIGN PROTOCOL

Moved to `references/playbooks.md` — The redesign protocol. Read it with `read_skill_file` when this step needs it.

## 12. THE BLOCK LIBRARY (Contract - Implementations Land Here Iteratively)

Moved to `references/playbooks.md` — The block library. Read it with `read_skill_file` when this step needs it.
...
Moved to `references/appendices.md` — Install commands, canonical sources, liquid glass. Read it with `read_skill_file` when this step needs it.
