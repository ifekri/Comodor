...
Comodor'un **Python 3.11 veya daha yenisi** ve etkileşimli arayüz için
[Bun](https://bun.sh) 1.3 veya daha yenisi gerekir — `comodor run` ve
`comodor web` onsuz çalışır. Başka hiçbir şey değil.
