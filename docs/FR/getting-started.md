...
Comodor a besoin de **Python 3.11 ou plus récent** et, pour l'interface
interactive, de [Bun](https://bun.sh) 1.3 ou plus récent — `comodor run` et
`comodor web` s'en passent. De rien d'autre.
