...
## المفتاح ليس اختياريًا هنا

لا تتوفر في واجهة المتصفح طريقة لإدخاله، لذا فمن دون مفتاح يذكر الحاوية ما ينقص وتقف، بدلًا من أن تقدّم عنوانًا يخفق عند أول مهمة.

يمرِّر Compose أيًّا من هذه المتغيرات المضبوطة في صدفتك (shell)، دون كتابتها في الصورة أو في ملف compose:
